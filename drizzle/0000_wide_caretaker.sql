...
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "user_id_index" ON "user_profile" USING btree ("user_id");

INSERT INTO "auth"."users" ("id", "email", "email_confirmed_at", "is_super_admin") VALUES ('6c6e1ced-a2cc-4dff-a15f-4d8926642b81', 'test_user@bill.com.br', now(), true)
